...
async function loadStoryboardJob() {
  try {
    ...
    console.error("[Online Image & Video Recognition] 载入分镜失败", error);
...
async function generateStoryboardImage() {
  ...
  try {
    ...
    console.error("[Online Image & Video Recognition] 生成分镜图片失败", error);
...
async function renderStoryboardCanvas() {
  ...
  context.fillText(`Generated by Online Image & Video Recognition · ${new Date().toLocaleString()}`, margin, height - 42);
