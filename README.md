...
Online Image & Video Recognition 是一个面向视频创作者的 Chrome Manifest V3 扩展，用于网页图片识别、视频分镜反推、提示词整理、AI 生图预览和视频下载辅助。

核心能力：支持修改故事大纲，并按新的内容方向同步调整后续分镜描述，方便把参考素材快速改写成自己的创意脚本。
